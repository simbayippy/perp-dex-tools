...
class PositionCloser:
    ...
    def _calculate_closing_fees(
        ...
        for fill_info in filled_orders:
            ...
            # Get fee structure for this DEX
    ...
    async def close(
        ...
        *,
        ...
        strategy = self._strategy
        # Store order_type for closing fee calculation
